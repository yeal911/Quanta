...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _translations = new()
    {
        ["zh-CN"] = new Dictionary<string, string>
        {
            ...
            ["Currency_ISK"] = "冰岛克朗",
            // ── 文本工具结果 ──────────────────────────────────────
            ["TextBase64EncodeResult"] = "Base64 编码",
            ["TextBase64DecodeResult"] = "Base64 解码",
            ["TextBase64DecodeFail"] = "Base64 解码失败",
            ["TextBase64DecodeFailHint"] = "输入不是有效的 Base64 或无法解码为 UTF-8 文本",
            ["TextUrlEncodeResult"] = "URL 编码",
            ["TextUrlDecodeResult"] = "URL 解码",
            ["TextJsonResult"] = "JSON ({0} 行)",
            ["TextJsonError"] = "JSON 格式错误",
            // ── 文件搜索 ───────────────────────────────────────────
            ["FileSearchInvalidDirs"] = "以下目录无效：",
            // ── 通用 ─────────────────────────────────────────────
            ["ColorCopied"] = "已复制: {0}",
            ["RecordingInProgress"] = "录音中...",
            ["TrayTooltip"] = "Quanta"
        ...
        ["en-US"] = new Dictionary<string, string>
        {
            ...
            // ── Text Tools Result ─────────────────────────────────────
            ["TextBase64EncodeResult"] = "Base64 Encode",
            ["TextBase64DecodeResult"] = "Base64 Decode",
            ["TextBase64DecodeFail"] = "Base64 Decode Failed",
            ["TextBase64DecodeFailHint"] = "Invalid Base64 input or cannot decode as UTF-8",
            ["TextUrlEncodeResult"] = "URL Encode",
            ["TextUrlDecodeResult"] = "URL Decode",
            ["TextJsonResult"] = "JSON ({0} lines)",
            ["TextJsonError"] = "JSON Format Error",
            // ── File Search ───────────────────────────────────────────
            ["FileSearchInvalidDirs"] = "Invalid directories:",
            // ── General ─────────────────────────────────────────────
            ["ColorCopied"] = "Copied: {0}",
            ["RecordingInProgress"] = "Recording...",
            ["TrayTooltip"] = "Quanta"
        ...
        ["es-ES"] = new Dictionary<string, string>
        {
            ...
            ["Currency_KRW"] = "Won coreano",
            ["Currency_HKD"] = "Dólar hongkonés",
            ["Currency_TWD"] = "Dólar taiwanés",
            ...
            ["Currency_BDT"] = "Taka bengalí",
            ["Currency_UAH"] = "Grivnia ucrania",
            ["Currency_RON"] = "Leu rumano",
            ["Currency_BGN"] = "Lev búlgaro",
            ["Currency_HRK"] = "Kuna croata",
            ["Currency_ISK"] = "Corona islandesa",
            // ── Resultados de Herramientas de Texto ─────────────────────────────────────
            ["TextBase64EncodeResult"] = "Codificar Base64",
            ["TextBase64DecodeResult"] = "Decodificar Base64",
            ["TextBase64DecodeFail"] = "Error al Decodificar Base64",
            ["TextBase64DecodeFailHint"] = "Entrada Base64 inválida o no se puede decodificar como UTF-8",
            ["TextUrlEncodeResult"] = "Codificar URL",
            ["TextUrlDecodeResult"] = "Decodificar URL",
            ["TextJsonResult"] = "JSON ({0} líneas)",
            ["TextJsonError"] = "Error de Formato JSON",
            // ── Búsqueda de Archivos ───────────────────────────────────
            ["FileSearchInvalidDirs"] = "Directorios inválidos:",
            // ── General ─────────────────────────────────────────────
            ["ColorCopied"] = "Copiado: {0}",
            ["RecordingInProgress"] = "Grabando...",
            ["TrayTooltip"] = "Quanta"
